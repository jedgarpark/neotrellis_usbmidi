/* This example shows basic usage of the NeoTrellis driver board as a USB MIDI controller.
  The buttons will light up various colors when pressed, and send a corresponding MIDI NoteOn/NoteOff message.
  The interrupt pin is not used in this example.
  Tested with a Feather M0 Express and using TinyUSB
*/
#include <Arduino.h>
